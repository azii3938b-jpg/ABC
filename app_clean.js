...
let db;
const WHATSAPP_NUMBER = "+923130823443";
...
window.openProductModal = async (id) => {
    ...
    if (p) {
        ...
        const waMessage = \`Hello DAURAN, I would like to purchase: \${p.name} (PKR \${p.price})\`;
...
We will confirm this order with you shortly.\`;
        ...
        alert("Thank you! Your order has been placed successfully. Uzair will contact you shortly.");
